...
import { recordChannelInteraction, twilioWhatsAppIngestInput } from "@/lib/channelIngest";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await recordChannelInteraction(twilioWhatsAppIngestInput(payload));
