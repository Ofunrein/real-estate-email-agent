...
export class OutlookCalendarProvider implements CalendarProvider {
  readonly provider = "outlook_calendar";

  private unavailable(): never {
    throw providerUnavailable(this.provider, "Direct Outlook Calendar provider is not wired yet. Use the Composio calendar provider or add Microsoft Graph credentials/client wiring.");
  }
